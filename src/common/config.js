...
// ▼ a2学習用サンドボックス化(すま, 2026-08-30): 本番ba backendから切り離し。
//   .invalid は解決しないため、閲覧GET/保存PUT/sessionいずれも本番に到達しない。
//   本番に戻す場合はこの行を https://ab-board-api.azurewebsites.net/api に戻す。
